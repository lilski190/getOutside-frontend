...
function Navbar() {
  ...
  return (
    <div id="NavBar" className="z-[99998] fixed bottom-0 w-screen h-14 flex flex-col justify-center items-center bg-dark-sea lg:top-0 lg:bottom-auto lg:items-end">
